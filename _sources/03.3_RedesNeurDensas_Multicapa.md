...
$$  W^1 = \begin{pmatrix} w^1_{11} & w^1_{21} \\  w^1_{12} & w^1_{22} \end{pmatrix}    \phantom{abc} 
    B^1 = \begin{pmatrix} b^1_1 & b^1_2 \end{pmatrix}    \phantom{abc} 
    W^2 = \begin{pmatrix} w^2_{11} & w^2_{21} \\  w^2_{12} & w^2_{22} \end{pmatrix}    \phantom{abc} 
...
\begin{bmatrix} \bar{\delta}^2 \cdot  (W^2)^T  \end{bmatrix} \odot f'\begin{pmatrix}\bar{z}^1\end{pmatrix}$$
...
$$\bar{\delta}^l = \bar{\delta}^{l+1} \cdot (W^{l+1})^T \odot f'(z^l) $$
